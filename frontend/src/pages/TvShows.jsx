...
function TvShows() {
  ...
  const featured = movies.tvShows[0]
    ...
    <div className="min-h-screen bg-[#141414]">
      ...
      <div className="relative h-[60vh] w-full">
        ...
        <div className="absolute bottom-[15%] left-0 px-4 sm:px-6 lg:px-8 max-w-xl">
          <span className="bg-red-600 text-white text-xs font-bold px-3 py-1 rounded mb-3 inline-block">TV SERIES</span>
      ...
      <div className="pb-16">
        <MovieRow title="Popular TV Shows" movies={movies.tvShows} onMovieClick={setSelectedMovie} />
        <MovieRow title="Binge-Worthy Thrillers" movies={movies.thriller} onMovieClick={setSelectedMovie} />
        <MovieRow title="Critically Acclaimed" movies={movies.drama} onMovieClick={setSelectedMovie} />
      </div>
