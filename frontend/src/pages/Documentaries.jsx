...
function Documentaries() {
  ...
  const featured = movies.documentary[0]
    ...
    <div className="min-h-screen bg-[#141414]">
      ...
      <div className="relative h-[60vh] w-full">
        ...
        <div className="absolute bottom-[15%] left-0 px-4 sm:px-6 lg:px-8 max-w-xl">
          <span className="bg-blue-500 text-white text-xs font-bold px-3 py-1 rounded mb-3 inline-block">DOCUMENTARY</span>
      ...
      <div className="pb-16">
        <MovieRow title="Popular Documentaries" movies={movies.documentary} onMovieClick={setSelectedMovie} />
        <MovieRow title="Nature & Science" movies={movies.documentary.filter(d => ['Planet Earth II', 'Our Planet', 'Free Solo'].includes(d.title))} onMovieClick={setSelectedMovie} />
        <MovieRow title="True Stories" movies={movies.drama} onMovieClick={setSelectedMovie} />
      </div>
