    ...
    <div className="min-h-screen bg-[#141414]">
      ...
      <div className="relative h-[60vh] w-full">
        ...
        <div className="absolute bottom-[15%] left-0 px-4 sm:px-6 lg:px-8 max-w-xl">
          <span className="bg-yellow-500 text-black text-xs font-bold px-3 py-1 rounded mb-3 inline-block">KIDS & FAMILY</span>
      ...
      <div className="pb-16">
        <MovieRow title="Kids Favorites" movies={movies.kids} onMovieClick={setSelectedMovie} />
        <MovieRow title="Family Adventures" movies={[...movies.kids].reverse()} onMovieClick={setSelectedMovie} />
        <MovieRow title="Fun For Everyone" movies={movies.trending} onMovieClick={setSelectedMovie} />
      </div>
