...
function Movies() {
  ...
  const featured = movies.action[3]
  ...
  return (
    <div className="min-h-screen bg-[#141414]">
      ...
      <div className="pb-16">
        <MovieRow title="Action & Adventure" movies={movies.action} onMovieClick={setSelectedMovie} />
        <MovieRow title="Thriller" movies={movies.thriller} onMovieClick={setSelectedMovie} />
        <MovieRow title="Drama" movies={movies.drama} onMovieClick={setSelectedMovie} />
        <MovieRow title="Sci-Fi & Fantasy" movies={movies.scifi} onMovieClick={setSelectedMovie} />
      </div>
